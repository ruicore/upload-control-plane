...
For the initial implementation, support API key authentication first.
...
The upload APIs are only one part of the control plane. The product API surface should be grouped around resources:
...
```json
{
  "task_name": "field-capture-2026-06-10-site-west",
  "task_initiator": "cli",
  "source_device_id": "2dc9ec4e-d1df-45bc-9ef9-49a5d09468b7",
  "source_device_code": "field-client-17",
...
```json
{
  ...
  "parts": [
    {
      "part_number": 1,
      "url": "http://localhost:9000/field-data/...?partNumber=1&uploadId=...&X-Amz-Signature=...",
    ...
    {
      "part_number": 2,
      "url": "http://localhost:9000/field-data/...?partNumber=2&uploadId=...&X-Amz-Signature=...",
      "expected_size_bytes": 67108864,
