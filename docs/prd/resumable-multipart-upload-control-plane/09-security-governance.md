...
Production deployments should support encryption-at-rest and retention controls as storage-policy decisions.
...
- Run metadata extraction and format parsing in a constrained worker environment because parsers for HDF5, images, archives, logs, or scientific formats may have their own vulnerabilities.
...
Datasets may contain sensitive research, customer, employee, or location data.
