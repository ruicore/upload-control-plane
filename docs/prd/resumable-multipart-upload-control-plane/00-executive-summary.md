...
# Production-Oriented Resumable Multipart Upload Control Plane
...
**Primary purpose:** production-oriented system design and implementation constraint document
**Intended downstream user:** engineers, implementers, and reviewers working from this document

---

## 0. Executive Summary

This repository implements a production-oriented large-file upload control plane for research, media, and field-data ingestion scenarios.
...
- Resumability after client crash, field-client power loss, network outage, or presigned URL expiry.
...
- Project, dataset, device, storage-policy, validation, lifecycle, and audit governance suitable for a field-data platform.
