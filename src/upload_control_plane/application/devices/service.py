...
from upload_control_plane.application.devices.credentials import (
...
class DeviceService:
    def __init__(self, session: Session) -> None:
        ...
        self._credentials = DeviceCredentialLifecycle(session)
    ...
    def register_device(
        ...
        *,
        ...
        self._session.flush()
        credential = self._credentials.provision(
            tenant_id=tenant_id,
            device=device,
            version=1,
    ...
    def rotate_credential(
        ...
        *,
        ...
        credential = self._credentials.rotate(
            tenant_id=tenant_id,
            device=device,
    ...
    def revoke_credentials(
        ...
        *,
        ...
        now = datetime.now(UTC)
        self._credentials.revoke(device_id=device.id, now=now)
        before = self._device_state(device)
